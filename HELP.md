...
* The original package name 'com.uniken.outh2-service' is invalid and this project uses 'com.uniken.outh2_service' instead.
...
* [OAuth2 Client](https://docs.spring.io/spring-boot/3.5.11-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.client)
